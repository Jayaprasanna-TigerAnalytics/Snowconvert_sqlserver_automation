...
----** SSC-FDM-0007 - MISSING DEPENDENT OBJECT "inserted" **
...
----** SSC-OOS - OUT OF SCOPE CODE UNIT. CREATE TRIGGER IS OUT OF TRANSLATION SCOPE. **
----** SSC-FDM-0007 - MISSING DEPENDENT OBJECTS "OrderStatusLog", "inserted", "deleted" **
...
----** SSC-OOS - OUT OF SCOPE CODE UNIT. CREATE TRIGGER IS OUT OF TRANSLATION SCOPE. **
----** SSC-FDM-0007 - MISSING DEPENDENT OBJECTS "PurchaseOrders", "deleted" **
...
----** SSC-OOS - OUT OF SCOPE CODE UNIT. CREATE TRIGGER IS OUT OF TRANSLATION SCOPE. **
----** SSC-FDM-0007 - MISSING DEPENDENT OBJECTS "PurchaseOrders", "inserted" **
...
----** SSC-OOS - OUT OF SCOPE CODE UNIT. CREATE TRIGGER IS OUT OF TRANSLATION SCOPE. **
----** SSC-FDM-0007 - MISSING DEPENDENT OBJECT "deleted" **
...
----** SSC-OOS - OUT OF SCOPE CODE UNIT. CREATE TRIGGER IS OUT OF TRANSLATION SCOPE. **
----** SSC-FDM-0007 - MISSING DEPENDENT OBJECTS "InventoryRestockLog", "inserted", "deleted" **
...
----** SSC-OOS - OUT OF SCOPE CODE UNIT. CREATE TRIGGER IS OUT OF TRANSLATION SCOPE. **
----** SSC-FDM-0007 - MISSING DEPENDENT OBJECTS "ShipmentDelayLog", "inserted" **
